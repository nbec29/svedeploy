...
def iniciarTestMEPiloto(request):
    ...
    if request.method == 'POST':
            ...
            cuelloseEfectuaMolestia=request.POST.get('La molestia se presenta cuando efectua que tipo de movimientos: Cuello')
            ...
            cuelloduracionMolestia=request.POST.get('Cuanto dura aproximadamente cada episodio de molestia o dolor : Cuello')
            ...
            espaldaDorsallaMolestiaEs=request.POST.get('Seleccione cada cuanto presenta la sintomatologia en su espalda Dorsal')
            espaldaDorsaleEfectuaMolestia=request.POST.get('La molestia se presenta cuando efectua que tipo de movimientos: espalda Dorsal')
            ...
            espaldaDorsalduracionMolestia=request.POST.get('Cuanto dura aproximadamente cada episodio de molestia o dolor : espalda Dorsal')
            espaldaDorsalinterfirioTrabajo=request.POST.get('Cuánto interfirió con su habilidad para trabajar : espalda Dorsal')
            ...
            espaldaBajalaMolestiaEs=request.POST.get('Seleccione cada cuanto presenta la sintomatologia en su espalda Baja')
            espaldaBajaeEfectuaMolestia=request.POST.get('La molestia se presenta cuando efectua que tipo de movimientos: espalda Baja')
            ...
            espaldaBajaduracionMolestia=request.POST.get('Cuanto dura aproximadamente cada episodio de molestia o dolor : espalda Baja')
            espaldaBajainterfirioTrabajo=request.POST.get('Cuánto interfirió con su habilidad para trabajar : espalda Baja')
...
<<<<<<< HEAD
    ...
    return render(request, 'hombro.html')


def enviarCorreoDiagnostico(prediccion, perfilDemografico, user):
    datos = 'Predicción: ' + str(prediccion) + ' - Cedula: ' + perfilDemografico.cedula0 + ' - Cargo: ' + perfilDemografico.cargo0.nombre + ' - Dpendencia: ' + perfilDemografico.dependencia0.nombre

    send_mail(
        'Diagnostico de Desorden Musculo-Esquelético',
         datos,
