...
from apps.Riesgos.models import Riesgo, PosibleEnfermedad, TestME, SabiasQue,poblacion,Cargo,Dependencia,PerfilDemografico,HombroME, CuelloME,CodoME,ManoME,EspaldaBajaME,EspaldaDorsalME
