...
urlpatterns = [
    ...
    path('musculoEsqueletico/testME/iniciarTestMEPiloto', login_required(iniciarTestMEPiloto),
         name='iniciarTestMEPiloto'),
    ...
    path('administrarSVE/aggenfermedad/editar/<int:identificacion>', login_required(enfermedadMEEdit),
         name='enfermedadMEEdit'),
    path('administrarSVE/aggenfermedad/eliminar/<int:identificacion>', login_required(enfermedadMEEliminar),
         name='enfermedadMEEliminar'),
    path('administrarSVE/aggenfermedad/informacionEnf/<int:identificacion>', login_required(informacionEnf),
         name='informacionEnf'),
    path('administrarSVE/aggenfermedad/defEnfMEEliminar/<int:identificacion>', login_required(defEnfMEEliminar),
         name='defEnfMEEliminar'),
    path('administrarSVE/aggenfermedad/defEnfMEEdit/<int:identificacion>', login_required(defEnfMEEdit),
         name='defEnfMEEdit'),
    ...
    path('administrarSVE/recomendaciones/Editar/<int:identificacion>', login_required(recomendacionesEdit),
         name='recomendacionesEdit'),
    path('administrarSVE/recomendaciones/eliminar/<int:identificacion>', login_required(recomendacionesEliminar),
         name='recomendacionesEliminar'),
    ...
    path('administrarSVE/poblacionSVE/editar/<int:identificacion>', login_required(poblacionEdit),
         name='EditarPoblacionME'),
    path('administrarSVE/poblacionSVE/eliminar/<int:identificacion>', login_required(poblacionEliminar),
         name='EliminarPoblacionME'),
